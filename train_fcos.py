...
def main(args):
    ...
    writer = SummaryWriter('./runs/FCOS')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        coco_info, acc, miou = utils.evaluate(model, val_data_set_loader, device=device)

        writer.add_scalar('mAP', coco_info[1], epoch)
        ...
        torch.save(save_files, "./save_weights/fcos/resNetFpn-model-{}.pth".format(epoch))
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./save_weights/FCOS', help='path where to save')
